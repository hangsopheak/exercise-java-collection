...
public class CollectionExercise {
	public static void main(String[] args) throws Exception {
		...
		Map<String, HashSet<String>> groupedCountries = new HashMap<String, HashSet<String>>();
	 ...
	 * @param list
	 */
	public static void convertToMapWithGrouping(Map<String, HashSet<String>> map, List<String> list){
		for(String country:list){
            ...
            if (listCountry == null) {
                ...
                map.put(firstLetter, (HashSet<String>) listCountry);
            }
